...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           {
               var strUrl = "&lt;%=path %>/atea/liuyan/liuyanHuifu.jsp?id="+id;
               var ret = window.showModalDialog(strUrl,"","dialogWidth:700px; dialogHeight:400px; dialogLeft:250px;help:no;status:no; directories:yes;scrollbars:yes;Resizable=no;");
