...
<html>
  <head>
	...
	<script type="text/javascript">
        ...
        {
            var url="<%=path %>/updown/updown.jsp?fujianPath="+fujianPath+"&amp;fujZianYuashiMing="+fujianYuashiMing;
            url=encodeURI(url); 
            url=encodeURI(url); 
  ...
  <div id="wrapper">
      ...
      <div id="footer">
	      <div id="copyright">
	        Copyright &copy; 2013 Company Name All right reserved&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=path %>/login.jsp">系统后台登录</a>
	      </div>
