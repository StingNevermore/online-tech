...
<html>
	...
	<script type="text/javascript">
        function liuyanAdd()
        {
            ...
            <s:if test="#session.userType == 2">
	             ...
	             var ret = window.showModalDialog(strUrl,"","dialogWidth:800px; dialogHeight:500px; dialogLeft:250px;help:no; status:no; directories:yes;scrollbars:yes;Resizable=no;");
  ...
  <div id="wrapper">
      ...
      <div id="right">
          ...
          <div id="footer">
              <div id="copyright">
                20142203623 李晓杰  《Java程序设计》&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=path %>/login.jsp">系统后台登录</a>
              </div>
